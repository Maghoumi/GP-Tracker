...
public class FromSample extends JFrame implements GLEventListener {
	...
	public FromSample(GLCapabilities capabilities) {
        ...
        this.setTitle("CUDA OpenGL Interop");
        
        this.setLayout(new BorderLayout());
        glComponent.setPreferredSize(new Dimension(100, 100));
	...
	public void initCuda() {
        ...
        this.getComponent(0).setPreferredSize(new Dimension(this.imageWidth, this.imageHeight));
        this.pack();
...
//	    gl.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_MAG_FILTER, GL2.GL_NEAREST);
	...
	public void display(GLAutoDrawable drawable) {
	    ...
	    gl.glTexSubImage2D(GL2.GL_TEXTURE_2D, 0, 0, 0,
	                    ...
	                    GL2.GL_RGBA, GL2.GL_UNSIGNED_BYTE, 0); //ZERO! NOT NULL! :-)
		...
		gl.glBindBuffer(GL2.GL_PIXEL_UNPACK_BUFFER, 0);
		gl.glBindTexture(GL2.GL_TEXTURE_2D, glTexture);
		gl.glTexSubImage2D(GL2.GL_TEXTURE_2D, 0, 0, 0, imageWidth, imageHeight, GL2.GL_BGRA, GL2.GL_UNSIGNED_BYTE, (Buffer)null);
		gl.glBindBuffer(GL2.GL_PIXEL_UNPACK_BUFFER, glBuffer);
